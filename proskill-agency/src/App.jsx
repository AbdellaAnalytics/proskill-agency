          ...
          <div>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 5, flexWrap: "wrap", gap: 4 }}>
              ...
              <div style={{ display: "flex", gap: 3, flexWrap: "wrap", alignItems: "center" }}>
                ...
                />
                {svcNames.length > 0 && <button onClick={() => setNewSale({ service: svcNames[0], customer: "", customerPhone: "", customerEmail: "", period: 1, price: 0, costPrice: 0, currency: "EGP", soldDate: gn(), notes: "" })} style={BP}>+ Sale</button>}
                {selBulk.length > 0 && (<>
