...
export default function App() {
  ...
  useEffect(() => {
    ...
    saveTimer = setTimeout(async () => {
      ...
      const doSave = async () => {
        ...
        pendingData = null;
        try {
          const r = await sb.saveData(workspaceOwnerId, snapshot);
          if (r.ok) {
  ...
  useEffect(() => {
    ...
    const retry = setTimeout(() => {
      if (pendingData && !saveInFlight) {
        ...
        const snapshot = pendingData;
        pendingData = null;
        sb.saveData(workspaceOwnerId, snapshot).then(r => {
          saveInFlight = false;
  ...
  const forceSyncNow = useCallback(async () => {
    ...
    saveInFlight = true;
    try {
      const r = await sb.saveData(workspaceOwnerId, dataToSave);
        ...
        {tab === "dashboard" && (
          <div>
            ...
            {(() => {
              ...
              const filteredForPeriod = doneSales.filter(a => {
